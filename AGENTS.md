...
This project is indexed by GitNexus as **ai-lab** (31002 symbols, 51560 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
